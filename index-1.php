...
<head>
    ...
    <title>Projet : UNA ARCHIVE</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="main-navigation">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">UFR SFA <span class="pe-7s-angle-down"></span></a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="header-1.html">Licence 1</a>
                                    <ul class="dropdown-submenu">
                                        <li><a href="index-agency-1.html">Mathémtiques - Informatiques</a></li>
                                    </ul>
                                </li>
                                <li><a href="header-2.html">Licence 2</a>
                                    <ul class="dropdown-submenu">
                                        <li><a href="index-agency-1.html">Mathémtiques</a></li>
                                        <li><a href="index-agency-1.html">Informatiques</a></li>
                                        <li><a href="index-agency-1.html">Physique - Chimie</a></li>
                                    </ul>
                                </li>
                                <li><a href="header-3.html">Licence 3</a>
                                    <ul class="dropdown-submenu">
                                        <li><a href="index-agency-1.html">Mathémtiques</a></li>
                                        <li><a href="index-agency-1.html">Informatiques</a></li>
                                        <li><a href="index-agency-1.html">Physique</a></li>
                                        <li><a href="index-agency-1.html">Chimie</a></li>
                                    </ul>
                                </li>
                                <li><a href="header-4.html">Master 1</a></li>
                                <li><a href="header-5.html">Master 2</a></li>
        ...
        <header id="headerwrap" class="backstretched fullheight agency-slider backstretch-overlay-alt">
            <div class="container vertical-center">
                <div class="intro-text vertical-center text-left smoothie">
                    <div class="intro-heading wow fadeIn heading-font" data-wow-delay="0.2s">Bienvenue sur UNA ARCHIVE</div>
                    <div class="intro-sub-heading wow fadeIn secondary-font" data-wow-delay="0.4s">Nous sommes ici pour <span class="rotate"> vous Aidez,vous Formez, Reussir</span></div>
        ...
        <section id="welcome">
            <div class="section-inner nopaddingbottom">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 mb100 wow">
                            <h2 class="section-heading">Bi To Kompleet</h2>
                            <h3 class="section-subheading secondary-font">Nous sommes Heureux de vous compter parmi nos membres.</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <p class="lead">UNA ARCHIVE à pour but d'aidez tous les etudiants de l'Université Nangui Abrigoua. </p>
                            <p>En Effet, cette Plateforme aura pour idée première de permettre aux etudiants de Consulter tous les cours et devoirs possibles dans leurs Différents Matières toutes filières confondues à partir de la Licence.</p>
                ...
                <div class="container">
                    <div class="row">
                                    ...
                                    <ul class="owl-carousel-paged testimonial-owl wow fadeIn list-unstyled" data-items="3" data-items-tablet="[768,2]" data-items-mobile="[479,1]">
                                        <li>
                                            <div class="row hover-item">
                                                <div class="col-xs-12">
                                                    <img src="assets/img/team/sfa.jpeg" class="img-responsive smoothie" alt="">
                                                </div>
                                                <div class="col-xs-12 hover-item-caption smoothie">
                                                    <div class="vertical-center">
                                                        <h3 class="smoothie"><a href="single-portfolio.html" title="view project">S.F.A</a></h3>
                                        ...
                                        <li>
                                            <div class="row hover-item">
                                                <div class="col-xs-12">
                                                    <img src="assets/img/team/sn.jpg" class="img-responsive smoothie" alt="">
                                                </div>
                                                <div class="col-xs-12 hover-item-caption smoothie">
                                                    <div class="vertical-center">
                                                        <h3 class="smoothie">
                                                            <a href="single-portfolio.html" title="view project"></a>S.N
                                                        </h3>
                                                        <ul class="smoothie list-inline social-links wow">
                                                            <li>
                                                                <a href="#"><i class="fa fa-twitter"></i></a>
                                        ...
                                        <li>
                                            <div class="row hover-item">
                                                <div class="col-xs-12">
                                                    <img src="assets/img/team/sta.jpg" class="img-responsive smoothie" alt="">
                                                </div>
                                                <div class="col-xs-12 hover-item-caption smoothie">
                                                    <div class="vertical-center">
                                                        <h3 class="smoothie"><a href="single-portfolio.html" title="view project">S.T.A</a></h3>
                                                        <ul class="smoothie list-inline social-links wow">
                                                            <li>
                                                                <a href="#"><i class="fa fa-twitter"></i></a>
                                                            </li>
                                        ...
                                        <li>
                                            <div class="row hover-item">
                                                <div class="col-xs-12">
                                                    <img src="assets/img/team/epss.jpg" class="img-responsive smoothie" alt="">
                                                </div>
                                                <div class="col-xs-12 hover-item-caption smoothie">
                                                    <div class="vertical-center">
                                                        <h3 class="smoothie"><a href="single-portfolio.html" title="view project">E.P.S.S</a></h3>
                                                        <ul class="smoothie list-inline social-links wow">
                                                            <li>
                                                                <a href="#"><i class="fa fa-twitter"></i></a>
                                                            </li>
                                        ...
                                        <li>
                                            <div class="row hover-item">
                                                <div class="col-xs-12">
                                                    <img src="assets/img/team/ste.jpg" class="img-responsive smoothie" alt="">
                                                </div>
                                                <div class="col-xs-12 hover-item-caption smoothie">
                                                    <div class="vertical-center">
                                                        <h3 class="smoothie"><a href="single-portfolio.html" title="view project">S.T.E</a></h3>
                                                        <ul class="smoothie list-inline social-links wow">
                                                            <li>
                                                                <a href="#"><i class="fa fa-twitter"></i></a>
                                                            </li>
                        ...
                        <div class="col-sm-3 match-height">
                            <div class="vertical-center">
                                <h2 class="section-heading">NOS FILIERES </h2>
                                <h3 class="section-subheading secondary-font"><span class="rotate"> Sciences Fondentales et Appliqués,Sciences Naturelles, Sciences et Technolgies des Aliments,Sciences T.............</span></h3>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="widget about-us-widget">
                                    ...
                                    <p>Professionally monetize team building materials for 24/7 results. Holisticly transition corporate platforms vis-a-vis cutting-edge experiences. Dynamically strategize ubiquitous applications for premier initiatives.
                                        Interactively seize resource sucking niche markets.</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="widget">
        ...
        <div class="viewport-wrap">
            <div class="viewport">
                ...
                <div class="widget about-us-widget mb50">
                    ...
                    <p>Professionally monetize team building materials for 24/7 results. Holisticly transition corporate platforms vis-a-vis cutting-edge experiences. Dynamically strategize ubiquitous applications for premier initiatives. Interactively seize
                        resource sucking niche markets.</p>
                </div>
            </div>
        </div>
    </div>
